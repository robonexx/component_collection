...
import { ProductCardWrapper, CardTitle, CardInfo, CardYear, AddToCart } from './styled'
...
const ProductCard: FC<Product> = ({title, year, price, id, image, itemPng}: Product) => {
  return (
    <AnimatePresence>
    ...
    <motion.div>
      ...
      <motion.img src={itemPng} alt={title}
